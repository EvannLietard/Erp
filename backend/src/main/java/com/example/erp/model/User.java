 ...
 * <p>
 * Un utilisateur possède un identifiant, un nom d'utilisateur, un mot de passe
 * (stocké hashé)
...
public class User {
     ...
     * @param companyId l'identifiant de la société associée à l'utilisateur   
     */
    public User(String username, String password, Set<String> roleIds, String companyId) {
    ...
    /**
     * Retourne les identifiants de la société associés à l'utilisateur.
     * 
     * @return companyId
     */
    ...
    /**
     * Définit l'identifiant de la société associée à l'utilisateur.
     * 
     * @param companyId l'identifiant de la société
     */
